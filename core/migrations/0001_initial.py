# Generated by Django 5.0.6 on 2024-06-28 18:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icone', models.CharField(choices=[('lni-rocket', 'Foguete'), ('lni-layers', 'Design'), ('lni-mobile', 'Mobile'), ('lni-users', 'Usuário'), ('lni-cog', 'Engrenagem'), ('lni-stats-up', 'Gráfico')], max_length=12, verbose_name='Incone')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imagem', stdimage.models.StdImageField(force_min_size=False, upload_to='equipe', variations={'thum': {'crop': True, 'height': 480, 'width': 480}}, verbose_name='Imagem')),
